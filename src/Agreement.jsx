  ...
  return (
    ...
    >
      ...
      <p>
        ...
        other intellectual property rights related to it, still belong to Namma
        Gaadi.
      </p>{" "}
      <p>
        Namma Gaadi is committed to ensuring that the app is as useful and
      ...
      <p>
        The NammaGaadi-Driver app stores and processes personal data that you
        ...
        phone’s security features and it could mean that the NammaGaadi-Driver
      ...
      <p>
        You should be aware that there are certain things that Namma Gaadi will
        ...
        Wi-Fi, or provided by your mobile network provider, but Namma Gaadi
      ...
      <p>
        Along the same lines, Namma Gaadi cannot always take responsibility for
        ...
        avail the Service, Namma Gaadi cannot accept responsibility.
      </p>{" "}
      <p>
        With respect to Namma Gaadi’s responsibility for your use of the app,
        ...
        make it available to you. Namma Gaadi accepts no liability for any loss,
      ...
      <p>
        ...
        using the app. Namma Gaadi does not promise that it will always update
      ...
      <p>These terms and conditions are effective as of 2020-10-06</p>{" "}
      <p>
        <strong>Contact Us</strong>
      </p>{" "}
      <p>
        If you have any questions or suggestions about our Terms and Conditions,
        do not hesitate to contact us at +91 91643 57339- Yeshwanth.
      </p>{" "}
      <p>
