...
import { Tabs, Tab, Form, Button, Table, Col, Toast, Spinner } from "react-bootstrap";
...
export default function SecondPage(homeprops) {
  ...
  useEffect(() => {
    setGenOtp(Math.floor(Math.random() * 100000));
  }, []);
  ...
  function handleChange(evt) {
    ...
    switch (name) {
      ...
      case "load":
        setState((prevState) => {
          return { ...prevState, load: value };
        });
        break;

      case "vehicle":
        setState((prevState) => {
          return { ...prevState, vehicle: value };
        });
        break;
      ...
      case "inp_otp":
        setState((prevState) => {
          return { ...prevState, inp_otp: value };
        });
        break;

      case "checked":
        setState((prevState) => {
          return { ...prevState, checked: !state.checked };
        });
        break;
  ...
  function handleClick(evt) {
    ...
    switch (name) {
      case "order":
        ...
        else alert("Please enter all credentials before continuing");
        break;
      ...
      case "gen_otp":
        if (state.phone.length === 10) generateOTP(state.phone, gen_otp);
        else alert("Please eneter a valid phone number");
        break;
      ...
      case "customer": {
        ...
        if (true) {
          ...
          !otpVerified
            ? alert("The OTP you entered is wrong. Please Check!")
            : setKey("verifyDetails");
        break;
      }
      case "pay":
    ...
    >
      <div style={{ margin: "auto auto" }}>
        <Tabs
          activeKey={key}
          onSelect={(k) => setKey(k)}
          style={{ margin: "auto auto", alignItems: "stretch" }}
        >
          <Tab
            eventKey="orderdetails"
            title={<h5 className="tabTitles">Vehicle</h5>}
          >
            <div style={{ margin: "2rem auto", width: "70%" }}>
              <Form.Row>
                <Col>
                  <label style={{ marginBottom: "0", alignSelf: "start" }}>
                    <h6>Enter the load in kg :</h6>
                  </label>
                  <Form.Control
                    required
            ...
            <div style={{ marginTop: "1.5rem", textAlign: "center" }}>
              ...
              >
                Continue <i className="fas fa-chevron-circle-right"></i>
              </Button>
            </div>
          </Tab>

          <Tab
            eventKey="locationDetails"
            title={<h5 className="tabTitles">Locations</h5>}
          >
            <Toast
              onClose={() => setLShow(false)}
              show={lshow}
              delay={4000}
            ...
            >
              <Toast.Header>
                <strong className="mr-auto">
                  Please drag the markers on the map to set locations
                  accurately.
                </strong>
              </Toast.Header>
            </Toast>
          ...
          <Tab
            ...
            title={<h5 className="tabTitles">Contacts</h5>}
          >
            <div style={{ margin: "2rem auto", width: "70%" }}>
              <Form.Control
                onChange={handleChange}
              ...
              {!otpVerified ? (
                <div>
                  ...
                  {otpProgress && (
                    <div style={{ textAlign: "center" }}>
                      <CircularProgress
                        style={{ color: "green", margin: "40px 0" }}
                      />
                    </div>
                  )}
                  <div style={{ textAlign: "center" }}>
                    <Button
                      ...
                      variant="success"
                      onClick={handleClick}
                      style={{ fontSize: "0.8rem", alignSelf: "right" }}
                    >
                      Generate OTP
                    </Button>
                  </div>
                  ...
                  <br />
                  <label style={{ marginBottom: "0", alignSelf: "start" }}>
                    <h6>Enter the OTP sent to your phone number :</h6>
                  </label>
                  <Form.Control
                    onChange={handleChange}
                    name="inp_otp"
                ...
                <div>
                  ...
                  <p>
                    If you wish to change your phone number, please refresh this
                    page and fill all details again
                  </p>
                </div>
              )}
          ...
          <Tab
            eventKey="verifyDetails"
            disabled
            title={<h5 className="tabTitles">Verify</h5>}
          >
            <Output verify={state} />
          </Tab>
        </Tabs>
  ...
  function Output(property) {
    ...
    return (
      <div>
        ...
        >
          <tbody>
            <tr>
              ...
              <td>
                <h6>{props.name === "" ? "Not Entered" : props.name}</h6>
              </td>
            </tr>

            <tr>
              <td>
                <h6>Vehicle Selected :</h6>
              </td>
              <td>
                <h6>{props.vehicle === "" ? "Not Entered" : props.vehicle}</h6>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <h6>
                  {pickupCity === "" ? "Not Entered" : pickupCity || pickupArea}
                </h6>
              </td>
            </tr>
        ...
        <div style={{textAlign: 'center', marginTop: 10}}>For any queries regarding the prices please contact us at +918792600639</div>
      </div>
    );
  }
